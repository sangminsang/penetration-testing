...
<!-- Scripts -->
<!-- [FIX] Bootstrap Bundle JS 추가 (모달 닫기 기능 활성화용) -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/4.0.1/socket.io.js"></script>
<script src="{{ url_for('static', filename='js/live_scan.js', version=1) }}"></script>


<script>
document.addEventListener('DOMContentLoaded', function() {
    console.log("✅ Modal Event Fix Initialized (v2)");
    ...
    document.body.addEventListener('click', function(e) {
        ...
        // 2. 복사 버튼 처리
        const copyBtn = e.target.closest('.btn-copy') || e.target.closest('.copy-btn') || (e.target.classList.contains('fa-copy') ? e.target.parentElement : null);
        
        if (copyBtn) {
            let textToCopy = copyBtn.getAttribute('data-clipboard-text');
            if (!textToCopy) {
                const sibling = copyBtn.previousElementSibling;
                if (sibling) textToCopy = sibling.innerText.trim();
            }
